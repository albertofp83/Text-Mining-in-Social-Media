...
path_training <- "/Users/bigdata/Google Drive/bigdata/15 - Text Mining Social Media/PAN-AP/training"		# Your training path
path_test <- "/Users/bigdata/Google Drive/bigdata/15 - Text Mining Social Media/PAN-AP/test"							# Your test path
k <- 3
r <- 1
